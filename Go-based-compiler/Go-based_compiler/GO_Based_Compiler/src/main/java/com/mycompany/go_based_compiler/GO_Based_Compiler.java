    ...
    public static void main(String[] args) {
        ...
        if (!Lex_Analysis.errorEncontrado) {
            ...
            if (!Syntax_Analysis.errorEncontrado) {
                ...
                Analisis_Semantico Semantic_Analysis = new Analisis_Semantico();

                System.out.println("Procediendo a inicializar el análisis semántico.\n");

                if (!Semantic_Analysis.errorEncontrado) {

                    System.out.println("--------------------------------------------");
                    System.out.println("Análisis semántico.");
                    System.out.println("--------------------------------------------\n");

                    Semantic_Analysis.analizarSemantica(Lista_Nodos_Sintactico);

                    System.out.println("\nAnálisis semántico terminado con éxito.");
